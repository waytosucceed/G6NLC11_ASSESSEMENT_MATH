...
function loadQuestion(index) {
  ...
  if (randomQuestion.inputBox) {
    ...
    document.getElementById("picdiv").classList.add("col-md-10");
    document.getElementById("picdiv").classList.add("col-lg-10");
    document.getElementById("picdiv").classList.add("col-sm-10");
    document.getElementById("picdiv").classList.add("col-xs-10");
    ...
    document.getElementById("question_background").style.width='70%';
    document.getElementById("question_background").style.height='70%';
    document.getElementById("question_background").style.height='25em';
...
if (mainDiv) {
  ...
  document.getElementById("picdiv").classList.add("col-xs-7");
    ...
    optionsElement.style.gap = "10px"; // Add space between images
    ...
    document.getElementById("questiondiv").classList.add("col-sm-5");
    document.getElementById("questiondiv").classList.add("col-xs-5");
    document.getElementById("questiondiv").classList.remove("col-md-4");
    document.getElementById("questiondiv").classList.remove("col-lg-4");
    document.getElementById("questiondiv").classList.remove("col-sm-4");
    document.getElementById("questiondiv").classList.remove("col-xs-4");
        ...
        document.getElementById("questiondiv").classList.remove("input");
    document.getElementById("questiondiv").classList.add("col-md-4");
    document.getElementById("questiondiv").classList.add("col-lg-4");
    document.getElementById("questiondiv").classList.add("col-sm-4");
    document.getElementById("questiondiv").classList.add("col-xs-4");
    document.getElementById("questiondiv").classList.remove("col-md-5");
    document.getElementById("questiondiv").classList.remove("col-lg-5");
    document.getElementById("questiondiv").classList.remove("col-sm-5");
    document.getElementById("questiondiv").classList.remove("col-xs-5");
